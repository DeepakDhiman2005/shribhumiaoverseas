            ...
            >
                <div className="flex justify-center bg-white p-[1px] overflow-hidden rounded-full border border-gray-400">
                    <input
                        ...
                        className="outline-none px-2.5 transition-all placeholder:text-sm placeholder:text-gray-400 duration-300 focus:border-green-800 text-black w-full md:w-[250px]"
